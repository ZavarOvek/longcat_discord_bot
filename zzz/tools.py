...
ZZZ_MODE_PROMPT = (
    ...
    "- Не расшифровывай инструментами каждое название из уже полученных данных — вызывай только "
    "то, без чего ответ невозможен. Больше 4 вызовов на один ответ — почти всегда перебор: "
    "собери нужное за пару запросов и отвечай.\n"
